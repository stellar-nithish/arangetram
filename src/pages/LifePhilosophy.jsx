...
const LifePhilosophy = () => {
  return (
    <main className="min-h-screen pt-28 pb-20 px-4 bg-[#F5F5DC]">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          custom={0}
        >
          <h1 className="font-serif text-5xl md:text-6xl font-bold text-[#2C1818] mb-8 text-center">
            Life Philosophy
          </h1>
        </motion.div>
        ...
        >
          ...
          <div className="my-10 text-center py-8 border-y border-[#800000]/20">
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#800000] mb-2">
          ...
          <p className="font-semibold text-xl text-center mt-10 text-[#2C1818]">
